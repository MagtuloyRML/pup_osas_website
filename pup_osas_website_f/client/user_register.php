    ...
    <div class="container">
      <div class="wrapper">
        ...
        <form action="#">
          ...
          <div class="row">
            <i class="fas fa-user"></i>
            <input type="text" id="stud_ID" name="#" placeholder="Student Number" required>
          </div>
          <div class="row">
            <i class="fas fa-user"></i>
          ...
          <div class="row">
            <i class="fas fa-user"></i>
            <input type="text" id="stud_ID" name="#" placeholder="Guardian" required>
          </div>
          <div class="row button">
            <input type="button" value="Signup" onclick="location.href='user_index.php';">
          </div>
        </form>
      </div>
    </div>
